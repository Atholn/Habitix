...
namespace Habitix.Data.Migrations
{
    ...
    [Migration("20210420191900_Add-Official-HabitDate-Date")]
    partial class AddOfficialHabitDateDate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Habitix.Data.Identity.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Habitix.Data.Models.HabitDate", b =>
                {
                    ...
                    b.Property<DateTime>("DateOfHabit")
                        .HasColumnType("datetime2");

                    b.Property<long>("HabitId")
                        .HasColumnType("bigint");

                    b.Property<bool>("IfHabitDone")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Habitix.Data.Identity.ApplicationUser", null)
                        .WithMany()
